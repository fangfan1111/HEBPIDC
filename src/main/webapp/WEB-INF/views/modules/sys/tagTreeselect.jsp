...
<head>
	...
	<style type="text/css">
	div.form-searchs{padding:10px 0 0 13px;display: block !important;}
	</style>
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				...
				data:{simpleData:{enable:true}},callback:{<%--
					...
					window.parent.$(".layui-layer-btn0").trigger("click");
// 						window.parent.window.$.jBox.getBox().find("button[value='ok']").trigger("click");
...
<body>
	...
	<div id="search" class="form-searchs" >
