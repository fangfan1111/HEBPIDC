		...
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			...
			<tbody><c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					...
					<shiro:hasPermission name="sys:menu:edit">
					<td nowrap>
					<a href="#" onclick="openDialogView('查看菜单', '${ctx}/sys/menu/formView?id=${menu.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>					
						<a href="${ctx}/sys/menu/form?id=${menu.id}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i>修改</a>
						...
						<a href="${ctx}/sys/menu/form?parent.id=${menu.id}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> 添加下级菜单</a> 
