	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
				<form:input path="value" htmlEscape="false" maxlength="50" class="form-control input-sm required"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
				<form:input path="type" htmlEscape="false" maxlength="50" class="form-control input-sm required abc"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">描述:</label>
			<div class="col-sm-10 controls">
				<form:input path="description" htmlEscape="false" maxlength="50" class="form-control input-sm required"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:dict:edit"><input id="btnSubmit" class="btn btn-primary pull-default" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
