	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(window.parent.document).find("#mainFrame").load(function(){
				...
				var thisheight = $(document).height()+550;
...
<div class="nav-tabs-custom">
	...
	<div class="breadcrumb">
		<form:form id="assignRoleForm" action="${ctx}/sys/role/assignrole" method="post" class="hide">
		...
		<script type="text/javascript">
			$("#assignButton").click(function(){
				//top.$.
				jBox.open("iframe:${ctx}/sys/role/usertorole?id=${role.id}", "分配角色",650,500,{
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable tree_table">
<!-- 		<thead> -->
