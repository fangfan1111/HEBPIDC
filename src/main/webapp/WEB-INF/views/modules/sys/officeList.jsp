	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="sys:office:edit"><td>
				<a href="${ctx}/sys/office/form?id={{row.id}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i>修改</a>
				...
				<a href="${ctx}/sys/office/form?parent.id={{row.id}}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>添加下级机构</a> 
