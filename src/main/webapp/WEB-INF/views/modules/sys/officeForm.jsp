...
<div class="nav-tabs-custom">
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
                <sys:treeselect id="office" name="parent.id" value="${office.parent.id}" labelName="parent.name" labelValue="${office.parent.name}"
					title="机构" url="/sys/office/treeData" extId="${office.id}" cssClass="form-control input-sm" allowClear="${office.currentUser.admin}"/>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
                <sys:treeselect id="area" name="area.id" value="${office.area.id}" labelName="area.name" labelValue="${office.area.name}"
					title="区域" url="/sys/area/treeData" cssClass="form-control input-sm required"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
				<form:input path="code" htmlEscape="false" cssClass="form-control input-sm" maxlength="50"/>
		</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
				<form:input path="address" htmlEscape="false" cssClass="form-control input-sm" maxlength="50"/>
	</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">邮政编码:</label>
			<div class="col-sm-10 controls">
				<form:input path="zipCode" htmlEscape="false" cssClass="form-control input-sm" maxlength="50"/>
	</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">负责人:</label>
			<div class="col-sm-10 controls">
			<form:input path="master" htmlEscape="false" cssClass="form-control input-sm"  maxlength="50"/>
		</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 controls">
				<form:input path="fax" htmlEscape="false" cssClass="form-control input-sm" maxlength="50"/>
	</div>
		</div>
		<div class="form-group">
			<label  class="col-sm-2 control-label">邮箱:</label>
			<div class="col-sm-10 controls">
				<form:input path="email" htmlEscape="false" cssClass="form-control input-sm" maxlength="50"/>
	</div>
		</div>
		<div class="form-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:office:edit"><input id="btnSubmit" class="btn btn-primary pull-default" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
