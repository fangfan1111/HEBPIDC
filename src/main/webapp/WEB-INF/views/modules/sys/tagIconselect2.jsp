...
<head>
    <title>图标选择</title>
		...
		<link href="${ctxStatic}/bootstrap/ace/assets/css/bootstrap.min.css" rel="stylesheet" />
		<link rel="stylesheet" href="${ctxStatic}/bootstrap/ace/assets/css/font-awesome.min.css" />
		<link rel="stylesheet" href="${ctxStatic}/bootstrap/ace/assets/css/ace.min.css" />
		<link rel="stylesheet" href="${ctxStatic}/bootstrap/ace/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="${ctxStatic}/bootstrap/ace/assets/css/ace-skins.min.css" />
		<script src="${ctxStatic}/bootstrap/ace/assets/js/ace-extra.min.js"></script>
		<script src="${ctxStatic}/bootstrap/ace/assets/js/jquery-1.10.2.min.js"></script>
		<script src="${ctxStatic}/bootstrap/ace/assets/js/bootstrap.min.js"></script>
		<script src="${ctxStatic}/bootstrap/ace/assets/js/typeahead-bs2.min.js"></script>
		<script src="${ctxStatic}/bootstrap/ace/assets/js/ace-elements.min.js"></script>
		<script src="${ctxStatic}/bootstrap/ace/assets/js/ace.min.js"></script>
    <style type="text/css">
...
<div id="icons">
	    ...
	    <ul class="the-icons">
	      ...
	      <li><i class="icon-music"></i> icon-icon-music</li>
