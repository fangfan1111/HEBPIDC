			...
			<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/form" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-10 controls">
						<form:select path="name" class="" style="width:250px;">
							<form:options items="${tableList}" itemLabel="nameAndComments" itemValue="name" htmlEscape="false"/>
						</form:select>
					</div>
					<div class="form-actions" style="padding-top:5%;">
						<input id="btnSubmit" class="btn btn-primary pull-default" type="submit" value="下一步"/>&nbsp;
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-6 controls">
							<form:input path="name" htmlEscape="false" maxlength="200" class="form-control input-sm required" readonly="true"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">说明:</label>
						<div class="col-sm-6 controls">
							<form:input path="comments" htmlEscape="false" maxlength="200" class="form-control input-sm required"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">类名:</label>
						<div class="col-sm-6 controls">
							<form:input path="className" htmlEscape="false" maxlength="200" class="form-control input-sm required"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">父表表名:</label>
						<div class="col-sm-10 controls">
							<form:select path="parentTable" cssClass="input-medium">
								<form:option value="">无</form:option>
								<form:options items="${tableList}" itemLabel="nameAndComments" itemValue="name" htmlEscape="false"/>
							</form:select>
							&nbsp;当前表外键：
							<form:select path="parentTableFk" cssClass="input-medium">
								<form:option value="">无</form:option>
