...
<div class="nav-tabs-custom">
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<form:select path="category" class="required input-medium">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<form:input path="packageName" htmlEscape="false" maxlength="500" class="required form-control input-sm"/>
				<span class="help-inline">建议模块包：cn.huazx.ebp.modules</span>
			</div>
		
			<label class="col-sm-2 control-label">生成模块名:</label>
			<div class="col-sm-4">
				<form:input path="moduleName" htmlEscape="false" maxlength="500" class="required form-control input-sm"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<form:input path="subModuleName" htmlEscape="false" maxlength="500" class="form-control input-sm"/>
				<span class="help-inline">可选，分层下的文件夹，例如 </span>
			</div>
	
			<label class="col-sm-2 control-label">生成功能描述:</label>
			<div class="col-sm-4">
				<form:input path="functionName" htmlEscape="false" maxlength="500" class="required form-control input-sm"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<form:input path="functionNameSimple" htmlEscape="false" maxlength="500" class="required form-control input-sm"/>
				<span class="help-inline">用作功能提示，如：保存“某某”成功</span>
			</div>
	
			<label class="col-sm-2 control-label">生成功能作者:</label>
			<div class="col-sm-4">
				<form:input path="functionAuthor" htmlEscape="false" maxlength="500" class="required form-control input-sm"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<form:select path="genTable.id" class="required input-medium">
			...
			<label class="col-sm-2 control-label">关联菜单:</label>
			<div class="col-sm-4">
		    <sys:treeselect id="menus" name="menu.id" value="${genScheme.menu.id}" labelName="menu.name" labelValue="${genScheme.menu.name}"
					title="菜单" url="/sys/menu/treeData" extId="${menu.id}" cssClass="form-control input-sm required"/>
