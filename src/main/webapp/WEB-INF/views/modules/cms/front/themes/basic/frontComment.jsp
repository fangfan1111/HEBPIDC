...
<script id="commentFormTpl" type="text/javascript"><!--/*-->
	<form:form action="${ctx}/comment" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea name="content" rows="4" maxlength="200" class="txt required" style="width:400px;float:left;margin-right:60px;"></textarea>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">姓&nbsp;&nbsp;&nbsp;名:</label>
			<div class="controls">
				<input type="text" name="name" maxlength="11" class="txt required" style="width:100px;height:24px;float:left;" value="匿名"/>
		...
		<div class="controls">
			...
			<sys:validateCode name="validateCode" inputCssStyle="float:left;height:24px;width:100px;"/>
