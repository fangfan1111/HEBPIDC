...
function showTip(d, b, c, a) {
	resetTip();
	setTimeout(function() {
		$.jBox.tip(d, (b == undefined || b == "" ? "info" : b), {
			opacity : 0,
...
function confirmx(c, b, a) {
	window.top.layer.confirm(c, {icon: 3, title:'系统提示'}, function(index){
...
//	$.jBox.confirm(c, "系统提示", function(d, e, g) {
//		if (d == "ok") {
...
function promptx(d, c, b, a) {
	$.jBox("<div class='form-search' style='padding:20px;text-align:center;'>"
			+ c + "：<input type='text' id='txt' name='txt'/></div>", {
		title : d,
		submit : function(e, g, i) {
			if (i.txt == "") {
				$.jBox.tip("请输入" + c + "。", "error");
				return false
			}
			if (typeof b == "function") {
				b()
